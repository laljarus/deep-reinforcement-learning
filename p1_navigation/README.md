...
3. Install Unity ML Agents by following the installation instruction in the github repository of [Unity ML Agents](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Installation.md). Otherwise use the project workspace provided.
